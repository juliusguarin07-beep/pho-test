                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <form @submit.prevent="submit" class="p-6">
                        <div class="space-y-6">
                            ...
                            <div class="border-t border-gray-200 pt-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <!-- Municipality (for PESU admins) -->
                                    <div v-if="form.user_type === 'pesu_admin'">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input
                                                ...
                                                required
                                                class="block w-full px-3 py-2 pr-10 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                        ...
                        <div class="mt-8 flex items-center justify-end space-x-3 border-t border-gray-200 pt-6">
                            <Link
                                :href="route('users.index')"
                                class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors duration-200"
                            >
                                Cancel
                            </Link>
                            <button
                                ...
                                class="inline-flex items-center px-4 py-2 border border-transparent rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50"
                            >
