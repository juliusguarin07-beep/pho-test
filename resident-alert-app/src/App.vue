...
onMounted(() => {
  ...
  const hasSeenSplash = localStorage.getItem('pho-alert-welcomed')
  if (hasSeenSplash) {
    showSplash.value = false
  }
...
<style scoped>
.nav-item {
  @apply flex flex-col items-center justify-center flex-1 py-2 text-gray-500 transition-colors duration-200;
}
